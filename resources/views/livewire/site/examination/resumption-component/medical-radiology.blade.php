    ...
    <div class="table-sec-1  ">
        <table style="width: 100%;" class="zui-table zui-table-rounded table-sec-3">
            ...
            <tbody>
                @foreach ($books as $book)
                    @foreach ($book->medicalRadiologies as $medicalTest)
                        <tr class="tr-body">
                            <td
                                style="border-right: unset !important; border-left: unset !important;border-top: unset !important;border-bottom:1px solid #dddada !important;">
                            ...
                            <td
                                style="border-right: unset !important; border-left: unset !important;border-top: unset !important;border-bottom:1px solid #dddada !important;">
                                <a href="{{ URL::asset('storage/' . $medicalTest->file) }}" data-lightbox="rad-image">
        ...
        @if ($updateFlag)
            <div class="medical-tests-1 py-1" id="addRadiologyDiv" style="display: block;">
                <div class="container">
                    <h6 class="mt-2">Update Medical Radiology</h6>
                    <div class="medical-sec-5">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 mt-2">
                                <label>Name</label>
                                <input type="text" wire:model="singleRad.name">
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6 mt-2">
                                <label>File</label>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 mt-2">
                                <label>Note</label>
                                <input type="text" wire:model="singleRad.note">
                            </div>
    ...
    <script>
        ...
        window.addEventListener('swal:DeleteConfirm', event => {
            swal({
                ...
                .then((result) => {
                    if (result) {
                        window.livewire.emit('deleteRad');
                    }
                });
        });
    </script>
